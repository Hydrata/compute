...
class ComputeViewSet(viewsets.ModelViewSet):
    ...
    def compute(self, request):
        ...
        subprocess.Popen(['mpirun', '-np', '16', '--oversubscribe', '/opt/venv/compute/bin/python', anuga_runfile, os.getenv("ANUGA_ADMIN_USERNAME"), os.getenv("ANUGA_ADMIN_PASSWORD")], cwd=os.path.join(package_subdirectory, 'code'))
